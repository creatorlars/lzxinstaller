...
set(CPACK_IFW_ROOT /opt/Qt/Tools/QtInstallerFramework/4.0 CACHE PATH "Qt Installer Framework installation base path")
endif()
...
elseif(APPLE)
    ...
    if(LINUXDEPLOYQT_EXECUTABLE)
        ...
        if(CMAKE_VERSION VERSION_LESS 3.13)
            linuxdeployqt("${CPACK_PACKAGE_DIRECTORY}/_CPack_Packages/Linux/AppImage" "share/applications/lzx.desktop")
        else()
            set(CPACK_GENERATOR "External;${CPACK_GENERATOR}")
